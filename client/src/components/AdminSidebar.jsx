...
const AdminSidebar = ({ isOpen, onClose }) => {
    ...
    const menuItems = [
        ...
        { name: 'Manajemen Soal', icon: <FileText size={22} />, path: '/admin/soal' },
        { name: 'Data Master', icon: <Database size={22} />, path: '/admin/master' },
                    ...
                    <div className="pt-4 mt-4 border-t border-gray-50">
                        ...
                        <div className="mt-4 px-4">
                            <p className="text-xs text-gray-400 font-medium">
                                &copy; {new Date().getFullYear()} Admin Bank Soal
                            </p>
                        </div>
                    </div>
                </div>
