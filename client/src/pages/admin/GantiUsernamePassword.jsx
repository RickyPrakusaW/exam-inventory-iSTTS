    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.success) {
                setMessage({ 
                    type: 'success', 
                    text: response.message || 'Username dan password berhasil diubah' 
                });
                ...
                setMessage({ 
                    type: 'error', 
                    text: response.message || 'Gagal mengubah username atau password' 
                });
            }
        } catch (error) {
            setMessage({ 
        ...
        <div className="space-y-6 md:space-y-8 pb-12">
            ...
            <div className="space-y-2">
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight flex items-center gap-2 md:gap-3">
                    <User className="text-rose-600 w-7 h-7 md:w-8 md:h-8" />
                    <span>Ganti Username & Password</span>
                </h1>
                <p className="text-gray-500 text-base md:text-lg">
                    Ubah username (email) dan password akun admin Anda
                </p>
            </div>
...
export default GantiUsernamePassword;
